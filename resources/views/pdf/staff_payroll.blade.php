...
@section('title', 'Bảng lương nhân viên '.$report['month'].'/'.$report['year'])
...
<table class="kv">
    ...
    <tr>
        ...
        <td>{{ $report['totals']['days'] }} ngày công</td>
    </tr>
</table>

<p class="note muted">
    Phải trả (net) = Gốc ngày công + Thưởng − Phạt − Ứng trước.
</p>
...
@else
    <table class="items">
        ...
        <tr>
            ...
            <td class="center bold">{{ $report['totals']['days'] }}</td>

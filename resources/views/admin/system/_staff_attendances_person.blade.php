...
@if(!$selectedUser)
    <div class="text-center text-muted py-5">
        ...
        <div class="mt-2">
            <a href="{{ route('admin.staff-attendances.index', ['mode' => 'day', 'date' => now()->toDateString()]) }}" class="btn btn-sm btn-primary">
                Hoặc chấm nhiều NV theo ngày →
            </a>
        </div>
    </div>
@else
...
<script>
(function () {
    if (typeof crmSelect2Local === 'function') {
